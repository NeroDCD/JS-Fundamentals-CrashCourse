...
// Select the HTML element with ID "myHeading" and set its text content to "Hello World"
document.getElementById("myHeading").textContent = `Hello World`;

// Select the HTML element with ID "myParagraph" and set its text content to "I Like Figma"
